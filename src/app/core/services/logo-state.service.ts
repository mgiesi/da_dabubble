...
export class LogoStateService {
  ...
  readonly logoSrc = computed(() => {
    return this.shouldShowWorkspaceLogo() ? "/icons/workspace-logo.svg" : "img/logo/DABubble-logo.png"
  })

  readonly headerTitle = computed(() => {
    return this.shouldShowWorkspaceLogo() ? this.currentChannelNameSignal() : "DABubble"
  })
